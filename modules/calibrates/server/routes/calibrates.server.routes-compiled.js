...
module.exports = function (app) {
  app.get('/table_equipment', controller.equipment).get('/table_main', controller.main).get('/table_location', controller.location);
};

//# sourceMappingURL=calibrates.server.routes-compiled.js.map